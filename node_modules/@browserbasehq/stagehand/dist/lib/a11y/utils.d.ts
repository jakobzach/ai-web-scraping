 ...
 */
export declare function buildHierarchicalTree(nodes: AccessibilityNode[], tagNameMap: Record<number, string>, logger?: (logLine: LogLine) => void, xpathMap?: Record<number, string>): Promise<TreeResult>;
/**
